...
def generate_comprehensive_course_catalog() -> List[Course]:
    ...
    courses.extend([
        Course("プログラミング基礎", "CS101", None, CourseCategory.MAJOR, RequirementType.COMPULSORY, 2, 1, 1, "2-3", []),
        Course("情報技術概論", "CS102", None, CourseCategory.MAJOR, RequirementType.COMPULSORY, 2, 2, 1, "2-3", []),
    ...
    courses.extend([
        ...
        Course("オブジェクト指向プログラミング", "CS202", None, CourseCategory.MAJOR, RequirementType.COMPULSORY, 2, 2, 2, "2-3", ["CS101"]),
        Course("システムプログラミング", "CS203", None, CourseCategory.MAJOR, RequirementType.ELECTIVE, 2, 1, 2, "4-5", ["CS103"]),
    ...
    courses.extend([
        Course("ソフトウェア工学", "CS301", None, CourseCategory.MAJOR, RequirementType.COMPULSORY, 2, 1, 3, "2-3", ["CS201", "CS202"]),
        Course("データベース設計", "CS302", None, CourseCategory.MAJOR, RequirementType.ELECTIVE, 2, 2, 3, "3-4", ["CS205"]),
        Course("ネットワークプログラミング", "CS303", None, CourseCategory.MAJOR, RequirementType.ELECTIVE, 2, 1, 3, "4-5", ["CS204"]),
    ...
    courses.extend([
        Course("卒業研究I", "CS401", None, CourseCategory.MAJOR, RequirementType.COMPULSORY, 4, 1, 4, "1-2", ["CS301"]),
        Course("卒業研究II", "CS402", None, CourseCategory.MAJOR, RequirementType.COMPULSORY, 4, 2, 4, "1-2", ["CS401"]),
    ...
    courses.extend([
        ...
        Course("微分積分学II", "MATH102", None, CourseCategory.COMMON_MATH, RequirementType.COMPULSORY, 2, 2, 1, "2-3", ["MATH101"]),
        Course("線形代数学I", "MATH201", None, CourseCategory.COMMON_MATH, RequirementType.COMPULSORY, 2, 1, 1, "3-4", []),
        Course("線形代数学II", "MATH202", None, CourseCategory.COMMON_MATH, RequirementType.COMPULSORY, 2, 2, 1, "3-4", ["MATH201"]),
    ...
    courses.extend([
        ...
        Course("英語II", "ENG102", None, CourseCategory.LANGUAGE, RequirementType.COMPULSORY, 2, 2, 1, "2-3", ["ENG101"]),
        Course("英語III", "ENG201", None, CourseCategory.LANGUAGE, RequirementType.COMPULSORY, 2, 1, 2, "3-4", ["ENG102"]),
        Course("英語IV", "ENG202", None, CourseCategory.LANGUAGE, RequirementType.COMPULSORY, 2, 2, 2, "3-4", ["ENG201"]),
    ...
    courses.extend([
        ...
        Course("キャリアデザイン", "GEN102", None, CourseCategory.UNIVERSITY_COMMON, RequirementType.COMPULSORY, 2, 2, 1, "3-4", []),
